//Questão 3
let data1: Date = new Date(prompt("Escreva a primeira data, ex: 10/10/2014. (Precisa ser menor do que a segunda)"));
let data2: Date = new Date(prompt("Escreva a segunda data, ex: 10/10/2014. (Precisa ser maior do que a segunda)"));
